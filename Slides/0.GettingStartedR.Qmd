...
### Over the next couple of years, you may expect to learn to use R to perform at least some fundamentals about: 
...
#| fig-width: 10
#| fig-height: 6.5
source("figures/christmasTree.R")
christmasTree()
```
</div>
...
#| fig-width: 10
#| fig-height: 6.5
source("figures/happyBirthday.R")
happyBirthday()
```
</div>
...
## one day you may create interactive webapps with Shiny

\
see [Shiny gallery](https://shiny.posit.co/r/gallery/#feature-demos){target="_blank"}

\
a couple of recent real examples from Psicostat members:
...
## 
#### A few R packages that you will/may need in the future (1/3)

| Package  |   Used for what  | Example(s) of functions
|-----|-------------|-----------|
| `base` <br/>(base R) | Basic functions | `sum`, `mean`, `sqrt`, `abs`, `c`, `data.frame`, `summary`, `plot`, `+`, `-`
...
## 
#### A few R packages that you will/may need in the future (2/3)
...
## 
#### A few R packages that you will/may need in the future (3/3)
