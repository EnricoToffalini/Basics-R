...
\
\
first of all, for getting started, follow the instructions in [*Chapter 1*](https://psicostat.github.io/Introduction2R_EN/install.html){target="_blank"} of *Introduction2R* to ensure that both 

- **R** (the basic software itself to run the programming language) and 
- **RStudio** (as the IDE of election)
