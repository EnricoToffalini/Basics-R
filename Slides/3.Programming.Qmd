...
For example, here's how you can rewrite the code for computing the *standard error of the mean* via *Monte Carlo simulation* using **`sapply`** instead of a `for` loop

<div class="large-code">
```{r}
results = sapply(1:10000, function(i) mean(rnorm(30,0,1)) )
