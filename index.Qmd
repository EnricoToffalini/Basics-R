...
This introductory course will prepare you for most future methodological courses in the [*PhD program in Psychological Sciences*](https://dottorato.psy.unipd.it/en){target="_blank"}, where R is extensively used. We will navigate the development environment, work with basic data structures like vectors and dataframes, learn about essential concepts of programming like loops and functions, and see some fundamentals of data visualization. Advanced topics like statistical modelling and data simulation will be covered in future courses and are **not** presented here (though occasional simple examples may appear). 
...
1.  **Bookmark this course homepage**: Save this link: [xxxxxxxxxxxxxxxxxxx](xxxxxxxxxxxxxxxxx) for easy access to course materials.
...
-   **topic 1** - [Slides](Slides/xxxxxxxxxxxxxxxxxx)
-   **topic 2** - [Slides](Slides/xxxxxxxxxxxxxxxxxx)
-   **topic 3** - [Slides](Slides/xxxxxxxxxxxxxxxxxx)
