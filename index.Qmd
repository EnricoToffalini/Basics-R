...
-   [<b>Data <em>nightmare</em> exercise</b>](Exercises/2.3-Exercises-DataScientist.html){target="_blank"}
-   [**Programming and more**](Exercises/3-Exercises-ProgrMore.html){target="_blank"}
