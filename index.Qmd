...
-   **Creating a word cloud** - [html](Exercises/3-WordCloud.html){target="_blank"}
    - <div style="font-size:14px;">see [here](Exercises/ExampleStrings.html){target="_blank"} some suggestions on manipulating strings</div>
-   **Monte Carlo simulations for Power analysis** - [html](Exercises/4-MonteCarloSim.html){target="_blank"}
    - <div style="font-size:14px;">see [here](Exercises/ExampleMC.html){target="_blank"} some examples of Monte Carlo simulations</div>
