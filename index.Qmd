...
<p style="color:#999999;"><em>**SECTION IN PROGRESS: NEW MATERIALS WILL BE ADDED HERE THROUGHOUT THE COURSE**</em></p>

#### Lectures Slides

-   **Getting Started with R** - [html](Slides/0.GettingStartedR.html){target="_blank"} - [pdf](Slides/0.GettingStartedR.pdf){target="_blank"}
-   **First Steps in R (part 1)** - [html](Slides/1.1.FirstStepsR-1.html){target="_blank"} - [pdf](xxxxxxxxxxxxxxxxxx){target="_blank"}
-   **First Steps in R (part 2)** - [html](Slides/1.2.FirstStepsR-2.html){target="_blank"} - [pdf](xxxxxxxxxxxxxxxxxx){target="_blank"}
-   **Data Structures** - [html](Slides/2.DataStructures.html){target="_blank"} - [pdf](xxxxxxxxxxxxxxxxxx){target="_blank"}
-   **Basics of Programming** - [html](Slides/3.Programming.html){target="_blank"} - [pdf](xxxxxxxxxxxxxxxxxx){target="_blank"}
