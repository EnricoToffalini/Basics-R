...
-   Use the `rnorm()` function to create an `y0` vector containing $1,000,000$ normally-distributed numbers (know that $1,000,000$ can be written as `1e+06` in R) on an IQ scale (i.e., with $\mu$ = $100$, $\sigma$ = $15$)
